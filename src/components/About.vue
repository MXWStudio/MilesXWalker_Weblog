...
<template>
          ...
          <aside class="profile-sidebar">
            ...
            <div class="social-media-block">
              ...
              <div class="social-links-wrapper">
                <a href="https://www.instagram.com/milesxwalker?igsh=cW0xZmM2czFndzgy&utm_source=qr" target="_blank" rel="noopener noreferrer" class="social-link instagram-link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" class="social-svg">
                    <defs>
                ...
                <a href="https://www.youtube.com/channel/UCWsm3OC_I_S572PVoz85CBg" target="_blank" rel="noopener noreferrer" class="social-link youtube-link">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" class="social-svg youtube-svg">
                    <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
                  </svg>
                  YouTube
                </a>
                <a href="https://space.bilibili.com/2092589163?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer" class="social-link bilibili-link">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" height="22" viewBox="0 0 48 48" class="social-svg bilibili-svg">
  ...
  .bilibili-svg path, .bilibili-svg rect {
    fill: #00a1f1;
  }
  .bilibili-link:hover {
