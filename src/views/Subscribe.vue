        ...
        <div class="contact-details-form">
          <div class="social-media-links-detailed">
            ...
            <div class="social-icons-grid">
              ...
              <a href="https://github.com/MXWStudio" target="_blank" rel="noopener noreferrer" class="social-card">
                <div class="card-image">
                  <img src="https://picsum.photos/300/200?random=3" alt="GitHub" />
                </div>
                <div class="card-content">
              ...
              <a href="https://x.com/MXWStudio" target="_blank" rel="noopener noreferrer" class="social-card">
                <div class="card-image">
                  <img src="https://picsum.photos/300/200?random=4" alt="Twitter/X" />
                </div>
                <div class="card-content">
              ...
              <a href="https://space.bilibili.com/2092589163?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer" class="social-card">
                <div class="card-image">
                  <img src="https://picsum.photos/300/200?random=5" alt="Bilibili" />
                </div>
                <div class="card-content">
          ...
          <form class="contact-form-main" @submit.prevent="handleSubmit">
            <p class="form-intro">Or, just drop me a line.</p>
